        ...
        <APIProvider apiKey={import.meta.env.VITE_GOOGLE_PLACE_API_KEY}>
            <div className="max-w-4xl mx-auto py-10 px-5">
                ...
                <div className="mt-10 space-y-10">
                    {/*  Destination Section Fixed */}
                    <div className="bg-gray-100 p-6 rounded-lg shadow">
                        <h2 className="text-xl font-semibold mb-3">What is your destination of choice?</h2>
                        <PlaceAutocomplete
                    ...
                    {/* Trip Duration */}
                    <div className="bg-gray-100 p-6 rounded-lg shadow">
                        <h2 className="text-xl font-semibold mb-3">How many days are you planning your trip?</h2>
                        <Input
                            placeholder="Ex. 3"
                            type="number"
                            className="w-full p-3 rounded-lg border-gray-300"
                    ...
                    {/* Travel Companions */}
                    <div className="bg-gray-100 p-6 rounded-lg shadow">
                        <h2 className="text-xl font-semibold mb-3">Who do you plan on traveling with?</h2>
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div className="mt-10 flex justify-center">
                    <Button disabled={loading} onClick={OngenerateTrip} className="font-bold py-3 px-6 rounded-lg shadow-md transition duration-300">
                    ...
                    <DialogContent className="bg-white p-4 rounded-lg shadow-lg max-w-sm mx-auto">
                        <DialogHeader className="text-left">
                            <DialogDescription className="flex flex-col items-start gap-2 text-gray-600">
                                <img src='/logo.svg' className="w-32 h-16 mt-0 animate-pulse" alt="App Logo" />
                                <DialogTitle className="text-lg font-bold text-gray-900">Sign In With Google</DialogTitle>
                                <DialogTitle className="text-sm text-gray-500">Sign in to the App with Google Authentication</DialogTitle>

                                <Button disabled={loading} onClick={login} className="w-full gap-4 items-center mt-2 font-bold px-4 py-2 rounded-lg shadow-md hover:bg-blue-600 transition duration-300">
